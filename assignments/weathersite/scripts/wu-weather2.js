...
weatherObject.open('GET', 'https://api.wunderground.com/api/d22a413415370da9/conditions/q/FL/Greenville.json', true);
...
forecastObj.open('GET', 'https://api.wunderground.com/api/d22a413415370da9/forecast10day/q/FL/Greenville.json', true);
